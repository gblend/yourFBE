...
export default {
                  ...
                  logs: [
                    {
                      ...
                      action:
                        'disableConfig: 62b34a8eb5d378221169d1cd - PATCH /disable/62b34a8eb5d378221169d1cd - by admin',
  ...
  '/logs/polling': {
    get: {
      tags: ['Logs'],
      description: 'Get polling logs',
      summary: 'retrieve polling logs',
      operationId: 'pollingLogs',
      security: [
        {
          bearerAuth: [],
        },
      ...
      responses: {
        '200': {
          description: 'Polling logs successful response',
          content: {
            'application/json': {
              example: {
                status: 'success',
                message: 'Polling logs fetched successfully',
                data: {
                  logs: [
                    {
                      _id: '62b35c71ba7af91ee98e97ee',
  ...
  '/logs/polling/{id}': {
    get: {
      tags: ['Logs'],
      description: 'Get polling log',
      summary: 'retrieve polling log',
      operationId: 'pollingLog',
      security: [
        {
          bearerAuth: [],
        },
      ...
      parameters: [
        {
          name: 'id',
          in: 'path',
          description: 'The id of the polling log to retrieve',
          type: 'string',
          example: '62b35c71ba7af91ee98e97ee',
        },
      ],
      responses: {
        '200': {
          description: 'Polling log successful response',
          content: {
            'application/json': {
              example: {
                status: 'success',
        ...
        '404': {
          description: 'Polling log not found',
          content: {
            'application/json': {
              example: {
                status: 'error',
                message: 'Polling log does not exist.',
                data: {},
              },
            },
          },
