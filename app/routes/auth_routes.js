...
const passportGoogle = require('../social_auth/google');
const passportFacebook = require('../social_auth/facebook');
const passportTwitter = require('../social_auth/twitter');
...
router.route('/google/callback').get(passportGoogle
		.authenticate('google', { assignProperty: 'socialProfile', failureRedirect: '/api/v1/social_auth/social-error' }),
...
router.route('/facebook/callback').get(passportFacebook
		.authenticate('facebook', { assignProperty: 'socialProfile', failureRedirect: '/api/v1/social_auth/social-error' }),
	(req, res) => socialLogin(req, res));
...
router.route('/twitter/callback').get(passportTwitter
		.authenticate('twitter', { assignProperty: 'socialProfile', failureRedirect: '/api/v1/social_auth/social-error' }),
	(req, res) => socialLogin(req, res));
