...
const FollowedFeed = model<IFollowedFeed, FollowedFeedModel>(
  'FollowedFeed',
  FollowedFeedSchema,
);

const validateFollowedFeedDto = (
  followedFeedDto: IFollowedFeed,
): ValidationResult => {
...
const validateFollowFeedsInCategoryDto = (
  followCategoryFeedsDto: IFollowCategoryFeed,
): ValidationResult => {
