...
const SavedForLater = model<ISavedForLater, SavedForLaterModel>(
  'SavedForLater',
  SavedForLaterSchema,
  'savedForLater',
);

const validateSavedForLaterDto = (saveForLaterDto: {
  post: any;
  feed: ObjectId;
  user: ObjectId;
}): ValidationResult => {
...
export { SavedForLater, validateSavedForLaterDto };
