...
const FeedCategory = model<IFeedCategory, FeedCategoryModel>(
  'FeedCategory',
  FeedCategorySchema,
);

const validateFeedCategoryDto = (
  feedCategoryDto: IFeedCategory,
): ValidationResult => {
...
export { FeedCategory, validateFeedCategoryDto };
